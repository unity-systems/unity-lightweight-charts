...
import { CustomPriceLineClickedEventHandler, CustomPriceLineClickedEventParams, CustomPriceLineDraggedEventHandler, CustomPriceLineDraggedEventParams, IChartApiBase,
	MouseEventHandler,
	MouseEventParams,
	PaneSize } from './ichart-api';
...
export class ChartApi<HorzScaleItem> implements IChartApiBase<HorzScaleItem>, DataUpdatesConsumer<SeriesType, HorzScaleItem> {
	...
	private readonly _customPriceLineClickedDelegate: Delegate<CustomPriceLineClickedEventParams> = new Delegate();
	private readonly _addButtonClickedDelegate: Delegate<MouseEventParams<HorzScaleItem>> = new Delegate();
